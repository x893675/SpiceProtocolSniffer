...
static string convUnsignedToStr (unsigned num)
{
    ostringstream oss;
    oss << num;
...
static string resizeStringByEndian (const string& str, unsigned digits, char ch = '0')
{
...
unsigned Time::getYear (void) const
{
    return(year_);
}

string Time::getYear (unsigned digits) const
{
    return( 0 == digits ?
            convUnsignedToStr(getYear()) : resizeStringByEndian(convUnsignedToStr(getYear()), digits) );
}

unsigned Time::getMonth (void) const
{
    return(month_);
}

string Time::getMonth (unsigned digits) const
{
    return( 0 == digits ?
            convUnsignedToStr(getMonth()) : resizeStringByEndian(convUnsignedToStr(getMonth()), digits) );
}

unsigned Time::getDayInWeek (void) const
{
    return(day_in_week_);
}

string Time::getDayInWeek (bool b_abbr) const
{
    switch (getDayInWeek()) {
        case 1:
...
unsigned Time::getDayInMonth (void) const
{
    return(day_in_month_);
}

string Time::getDayInMonth (unsigned digits) const
{
    return( 0 == digits ?
            convUnsignedToStr(getDayInMonth()) : resizeStringByEndian(convUnsignedToStr(getDayInMonth()), digits) );
}

unsigned Time::getDayInYear (void) const
{
    return(day_in_year_);
}

string Time::getDayInYear (unsigned digits) const
{
    return( 0 == digits ?
...
string Time::getHour (unsigned digits) const
{
    return( 0 == digits ?
            convUnsignedToStr(getHour()) : resizeStringByEndian(convUnsignedToStr(getHour()), digits) );
}

unsigned Time::getMinute (void) const
{
    return(minute_);
}

string Time::getMinute (unsigned digits) const
{
    return( 0 == digits ?
            convUnsignedToStr(getMinute()) : resizeStringByEndian(convUnsignedToStr(getMinute()), digits) );
}

unsigned Time::getSecond (void) const
{
    return(second_);
}

string Time::getSecond (unsigned digits) const
{
    return( 0 == digits ?
